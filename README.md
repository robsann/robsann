...
- Configured in VirtualBox: DHCP Server, Ubuntu VM (Elastic Host), Windows 10 VM (Victim).
- Configured Elastic 8.8: Elastic Stack (Elasticsearch and Kibana) and Integrations (Fleet Server,
Elastic Agent, Elastic Defend, System, Windows, and Network Packet Capture).
